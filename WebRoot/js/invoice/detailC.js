						...
						$("#workerList")
								.append(
										"<tbody  id='worker"
												...
												+ "<tr><td style='width:300px; border-top:0px ;border-left:0px;border-right:0px;border-bottom:0px;'><strong>Position:</strong></td>"
												+ "<td><input id='position"
												+ data[i].id
												+ "'  type='text' style=' border-top:0px ;border-left:0px;border-right:0px;border-bottom:0px;'  />"
												+ "</td></tr><tr>"
												 ...
												 * type='text' " +
												 * "id='salaryCost" + data[i].id + "'
												 * style='width:80%;border-top:0px
												 * ;border-left:0px;border-right:0px;border-bottom:0px;'
												 * onkeyup='caculateC(" +
												 * data[i].id + ")'/></td>"
												 */
						...
						$("#remark" + data[i].id)
								.append(
										"<tr><td >"
												...
												+ "data-parsley-id='50' style=' width: 100%; height: 50px;border-style: solid; border-color: #FFFFFF;resize: none;'>"
												+ data[i].remark
												+ "</textarea>" + "</td></tr>");
